...
class DataService {
   Future insertEmployee(String appid, String home, String nama, String phone, String email, String address, String gender, String birthday, String profpic) async {
      String uri = 'https://io.etter.cloud/v4/insert';

      try {
         final response = await http.post(Uri.parse(uri), body: {
            'token': '63476b7a99b6c11c094bd515',
            'project': 'office',
            'collection': 'employee',
            'appid': appid,
            'home': home,
